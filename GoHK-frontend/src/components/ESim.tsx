  ...
  return (
    <div className='p-1 h-[70vh] overflow-y-auto'>
      <div className='w-97/100'>
        <div className='text-lg md:text-xl lg:text-xl font-semibold border-b pb-3 border-black/10'>SIM & Internet</div>
          <div className='rounded-lg border-black/10 mt-3'>
            <div> {/* companies */}
              <div> {/* CSL */}
                <div className='flex shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.1),0_4px_6px_-1px_rgba(0,0,0,0.1)] items-center gap-x-4 bg-amber-300/20 py-2 px-2 lg:px-1 rounded-t-lg'>
                  <img src={csl} alt="" className='ml-3 w-7 h-6 lg:w-8 lg:h-7'/>
                  {/* <FaSimCard className='ml-3' size={25}/> */}
                  <p className='text-lg md:text-xl lg:text-2xl font-medium'>CSL – “Discover Hong Kong Tourist SIM”</p>
                </div>
                <div className='flex border-b border-x border-black/10 rounded-b-lg p-2'>
                  <div className='w-4/5 border-r border-black/10'> {/* Left side */}
                    <p className='text-lg lg:text-xl font-medium'>Where to buy:</p>
                    <ul className="list-disc pl-5 text-xs md:text-sm lg:text-lg">
                  ...
                  <div className='w-4/5 ml-2'> {/* Right side */}
                    <p className='text-lg lg:text-xl font-medium mb-2'>Plans & Data:</p>
                    <div className='flex items-center'>
                      <div className='flex flex-col justify-start items-center w-4/5 border-r border-black/10 text-[10px] md:text-xs lg:text-sm text-center p-1 md:p-0 h-full'>
                        <p className='font-medium'>7-Day Pass</p>
                        <p>~HK$88</p>
                        <p>~50GB total</p>
                      ...
                      <div className='flex flex-col justify-start items-center w-4/5 h-full text-[10px] md:text-xs lg:text-sm text-center p-1 md:p-0 '>
                        <p className='font-medium'>15-Day Pass</p>
                        <p>~HK$118</p>
                        <p>~80GB total</p>
                        <p>Unlimited local calls</p>
                        <p>Free CSL Wi-Fi</p>
              ...
              <div className='flex flex-col lg:flex-row justify-between'>
                <div className='lg:w-1/2 w-full mr-1'> {/* 7-Eleven */}
                  <div className='flex mt-3 items-center gap-x-4 bg-red-300/20 py-2 px-2 lg:px-1 rounded-t-lg'>
                    <img src={sevenEleven} className='ml-3 w-6 h-6 lg:w-7 lg:h-7'/>
                    <p className='text-lg md:text-xl lg:text-2xl font-medium'>7-Eleven Tourist SIM Cards</p>
                  </div>
                  <div className='flex flex-col justify-around border-b border-x border-black/10 rounded-b-lg p-2'>
                    <div className='border-black/10'> {/* Left side */}
                      <p className='text-lg lg:text-xl font-medium'>Where to buy:</p>
                      <ul className="list-disc pl-5 text-xs md:text-sm lg:text-lg mb-3 md:mb-0">
                    ...
                    <div> {/* Right side */}
                      <p className='text-lg lg:text-xl font-medium mb-0 md:mb-2'>Plans & Data:</p>
                        <div className='flex items-center'>                    
                          <div className='flex flex-col justify-start items-center w-4/5 border-r border-black/10 h-full text-[10px] md:text-xs lg:text-sm text-center p-1 md:p-0 '>
                            <p className='font-medium'>3-Day 5G Hong Kong Card</p>
                            <p>HK$38</p>
                          ...
                          <div className='flex flex-col justify-start items-center w-4/5 h-full text-[10px] md:text-xs lg:text-sm text-center p-1 md:p-0'>
                            <p className='font-medium'>Standard 3-Day SIM</p>
                            <p>HK$48</p>
                            <p>~15GB local data</p>
                            <p>Valid for 3 days</p>
                            <p>Details: <a target='_blank' className='text-blue-500 hover:text-blue-800' href="https://www.7-eleven.com.hk/en/service/prepaid-sim/for-hong-kong-tourists?srsltid=AfmBOoqJBKlV9d-iumfpFZT25csOnOO_ymldx5GoEyXTaNpbZBzycIyM&">Click here</a></p>
                ...
                <div className='ml-1 lg:w-8/10 w-full'> {/* China Mobile Hong Kong */}
                  <div className='flex mt-3 items-center gap-x-4 bg-green-300/20 py-2 px-2 lg:px-1 rounded-t-lg'>
                    <img src="" alt="" />
                    <img src={chinaMobile} alt="" className='w-6 h-6 lg:w-7 lg:h-7'/>
                    <p className='text-lg md:text-xl lg:text-2xl font-medium'>China Mobile Hong Kong Tourist Physical SIM</p>
                  </div>
                  <div className='flex flex-col border-b border-x border-black/10 rounded-b-lg p-2'>
                    ...
                    <div className=''> {/* Right side */}
                      <p className='text-lg lg:text-xl font-medium mb-2'>Plans & Data:</p>
                        <div className='flex items-center'>                    
                          <div className='flex flex-col justify-start items-center w-4/5 border-r border-black/10 h-full text-[10px] md:text-xs lg:text-sm text-center p-1 md:p-0'> 
                            <p className='font-medium'>5G Hong Kong Tourist SIM card (7-day)</p>
                            <p>HK$100</p>
                          ...
                          <div className='flex flex-col justify-start items-center w-4/5 h-full text-[10px] md:text-xs lg:text-sm text-center p-1 md:p-0'>
                            <p className='font-medium'>30-Days Unlimited Variant</p>
                            <p>HK$38</p>
